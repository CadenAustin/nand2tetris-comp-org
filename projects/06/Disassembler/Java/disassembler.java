...
//	java disassembler "sample.hack" (this is executing your program)
		...
		if (args[0].contains(".hack"))
		{
			...
			if (Files.exists(Paths.get(args[0])))
			{
				...
				Hashtable<String,String> compTable = new Hashtable<String, String>();
					compTable.put("101010", "0");
					compTable.put("111111", "1");
					compTable.put("111010", "-1");
					compTable.put("001100", "D");
					compTable.put("110000", "A,M");
					compTable.put("001101", "!D");
					compTable.put("110001", "!A,!M");
					compTable.put("001111", "-D");
					compTable.put("110011", "-A,-M");
					compTable.put("011111", "D+1");
					compTable.put("110111", "A+1,M+1");
					compTable.put("001110", "D-1");
					compTable.put("110010", "A-1,M-1");
					compTable.put("000010", "D+A,D+M");
					compTable.put("010011", "D-A,D-M");
					compTable.put("000111", "A-D,M-D");
					compTable.put("000000", "D&A,D&M");
					compTable.put("010101", "D|A,D|M");
				...
				for (String lineStr : Lines)
				{
					...
					// else if - Check instruction op-code (the first char in the char[])
						...
						//		String compVal = compList[Character.getNumericValue(aBit)];
